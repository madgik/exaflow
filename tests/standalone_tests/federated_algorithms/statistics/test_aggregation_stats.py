...
from exaflow.algorithms.federated.statistics.aggregation_stats import (
    CoefficientOfVariation,
)
from exaflow.algorithms.federated.statistics.aggregation_stats import Covariance
from exaflow.algorithms.federated.statistics.aggregation_stats import FedCount
from exaflow.algorithms.federated.statistics.aggregation_stats import (
    LeastSquaresRegression,
)
from exaflow.algorithms.federated.statistics.aggregation_stats import Mean
from exaflow.algorithms.federated.statistics.aggregation_stats import (
    MeanAbsoluteDeviation,
)
from exaflow.algorithms.federated.statistics.aggregation_stats import MeanSquare
from exaflow.algorithms.federated.statistics.aggregation_stats import PearsonCorrelation
from exaflow.algorithms.federated.statistics.aggregation_stats import Range
from exaflow.algorithms.federated.statistics.aggregation_stats import RootMeanSquare
from exaflow.algorithms.federated.statistics.aggregation_stats import StandardDeviation
from exaflow.algorithms.federated.statistics.aggregation_stats import (
    StandardizedMeanDifferences,
)
from exaflow.algorithms.federated.statistics.aggregation_stats import Variance
...
METHOD_TO_CLASS = {
    ...
    "standardized_mean_differences": StandardizedMeanDifferences,
}
...
class TestPrimitiveFederatedStats(FederatedAlgorithmTest):
    def compute_centralized_result(self, X, y, **kwargs):
        ...
        if method == "fed_count":
            ...
            return r
        elif method == "least_squares_regression":
    ...
    def compute_federated_result(self, X, y, *, agg_client, **kwargs):
        ...
        method = kwargs["method"]
        stats_algo = METHOD_TO_CLASS[method](aggregator)
